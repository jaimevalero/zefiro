...
| multilevel    | App para adaptar examenes y lecciones a alumnos con necesidades específicas espececiales ( dislexia, espectro autista,deficit de atención, ...) [agentes](etc/configs/multilevel/config/agents.yaml) [tareas](etc/configs/multilevel/config/tasks.yaml)     |   | [multilevel.md](meta-crew-frontend/static/examples/multilevel.md) ⭐            |

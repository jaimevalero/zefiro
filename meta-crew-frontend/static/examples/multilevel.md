# Caso ficticio : Examen de matemáticas para 3° de primaria
...
**D. TEA Nivel 1**:  
- Versión D:  
  - Diagramas de flujo para problemas:  
    [Cajas]→[12 lápices]→[Total=?]  
  - Cuadrículas cerradas para cada operación  

**E. Dificultades no diagnosticadas**:  
- Versión E:  
  - Reducción a 2 multiplicaciones + 2 divisiones + 2 problemas  
  - Plantillas con pasos pre-impresos: "1. Identificar datos → 2. Elegir operación → 3. Calcular"  

---

### **7. ALINEACIÓN PEDAGÓGICA**  
Todas las versiones mantienen:  
- 4 operaciones básicas (2 con decimales)  
- 1 problema de cada tipo (agrupación, reparto, medida)  
- 2 propiedades fundamentales (4a y 4c)  

**Herramientas de equidad**:  
- Mismo baremo de corrección para todas las versiones  
- Opción de usar material manipulativo (ábaco/regletas) como "ayuda técnica"  

---

### **8. PROPUESTA DE IMPLEMENTACIÓN**  
1. **Distribución simultánea**: 5 versiones (A-E) mezcladas en el aula para evitar estigmatización  
2. **Temporalización flexible**:  
   - Base 45 minutos + 15 minutos extra opcionales  
   - Reloj visual proyectado para TDAH/TEA  
3. **Integración PT**: Apoyo en lectura de enunciados (solo versión C) y gestión tiempo  

Este análisis garantiza evaluación equitativa manteniendo el rigor académico, con variaciones metodológicas que respetan los estilos de aprendizaje identificados.

---

# 2 Informe: Plan De Adaptaciones Curriculares Multinivel Con Matriz De Ajustes Por Perfil

**PLAN DE ADAPTACIONES CURRICULARES MULTINIVEL - EXAMEN DE MATEMÁTICAS 3° PRIMARIA**  

---

### **MATRIZ DE ADAPTACIONES POR PERFIL**  
| Perfil | Adaptaciones de **Contenido** | Adaptaciones de **Proceso** | Adaptaciones de **Producto** | Recursos |  
|--------|-------------------------------|-----------------------------|------------------------------|---------|  
| **TDAH** | - Reducción a 6 ejercicios clave (2 mult/2 div/2 problemas)<br>- Enunciados con palabras clave resaltadas | - Examen dividido en 3 bloques de 15 min con pausas activas<br>- Temporizador visual proyectado en pizarra digital | Respuestas en cuadros delimitados con autoinstrucciones: "1. Calcular → 2. Revisar → 3. Marcar" | Tabla de multiplicar en tarjetas de colores |  
| **Altas capacidades** | - Problemas de extensión:<br> *"Si 125,6 × 59 = 7,410.4, calcula 251,2 × 59"*<br>- Pregunta de creación: *"Inventa un problema que use 78,25 × 47"* | - Opción de saltar ejercicios básicos tras demostrar dominio (3 respuestas correctas consecutivas) | Rúbrica de evaluación ampliada con criterios de creatividad y conexiones matemáticas | Plantillas para problemas extendidos |  
| **Dislexia** | - Numeración con iconos (🔢 para cálculos, 📚 para problemas)<br>- Enunciados en formato bullet:<br> *"Datos: 24 cajas - 12 lápices cada una<br>Pregunta: Total lápices"* | - Textos en Arial 14 con espaciado 1.5<br>- Uso de ábaco para verificaciones | Respuestas en formato oral grabado (solo para problemas verbales) | Ábaco + plantilla numéricaoresoresores |  
| **TEA Nivel 1** | - Diagramas de flujo para problemas:<br> [Cajas]→[12 lápices]→[Total=?]<br>- Eliminación de preguntas 4a y 4d (abstracción compleja) | - Hoja estructurada en 4 zonas delimitadas con bordes<br>- Instrucciones por pasos numerados | Respuestas en tablas pre-diseñadas con casillas de verificación | Plantilla de secuenciación visual |  
| **Dificultades no diagnosticadas** | - Versión simplificada:<br> *45,5 ÷ 3 → 45 ÷ 3*<br>- Ejemplos resueltos al margen: *"56 ÷ 8 = 7 (porque 8×7=56)"* | - Tiempo extendido a 60 min<br>- Agrupamiento con apoyo PT durante 15 min iniciales | Respuestas con opción múltiple para 2 problemas: *"96 ÷ 24 = a)4 b)5 c)6"* | Regletas + modelo de pasos en póster |  
...
Este plan garantiza equidad educativa mediante 5 vías de acceso al mismo currículo, cumpliendo con los principios del DUA y manteniendo el rigor académico para todos los perfiles.
...
**SECCIÓN 3: Verdadero/Falso Modificado**  
